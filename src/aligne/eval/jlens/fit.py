...
from aligne.eval.jlens.artifacts import save_jlens
from aligne.eval.jlens.convergence import ConvergenceReport, ConvergenceSpec, Round, compare
from aligne.eval.jlens.datasets import FitDataset, Sequence, sequences
...
class FitConfig:
    ...
    cache_dir: str | None = None  # aligne.data.hfdata on-disk cache
